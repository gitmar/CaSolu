...
static void
wasm_invoke_iiiilli (void *target_func, MonoInterpMethodArguments *margs)
{
	typedef int (*T)(int arg_0, int arg_1, int arg_2, int64_t arg_3, int64_t arg_4, int arg_5);
	T func = (T)target_func;
	int res = func (mono_wasm_interp_method_args_get_iarg (margs, 0), mono_wasm_interp_method_args_get_iarg (margs, 1), mono_wasm_interp_method_args_get_iarg (margs, 2), mono_wasm_interp_method_args_get_larg (margs, 3), mono_wasm_interp_method_args_get_larg (margs, 5), mono_wasm_interp_method_args_get_iarg (margs, 7));
	void *retval = mono_wasm_interp_method_args_get_retval (margs);
	*(int*)retval = res;
}
...
static unsigned int interp_to_native_signatures_count = 48;
